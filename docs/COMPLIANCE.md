...
| **Short-lived credentials** | CC6.1 | A.5.17, A.8.5 | M2M access-token TTL set to **15 minutes** (`token_lifetime = 900`) instead of the 24 h default, shrinking the replay window. | `terraform/auth0/`, `EVAL_FINDINGS`/SESSION_NOTES |
